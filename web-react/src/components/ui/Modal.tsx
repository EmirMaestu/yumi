  ...
  return (
    <Dialog.Root open={open} onOpenChange={(o) => { if (!o) onClose() }}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="nf-modal" onOpenAutoFocus={(e) => e.preventDefault()} style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 61, width: 'min(440px, 92vw)', borderRadius: 16, padding: 22, maxHeight: '88vh', overflowY: 'auto', background: 'var(--color-linen)', boxShadow: '0 8px 40px rgba(18,22,19,0.18)' }}>
